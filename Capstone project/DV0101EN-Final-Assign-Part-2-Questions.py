...
app.layout = html.Div(children=[
    ...
    html.Div(id='output-container', className='chart-grid', style={'display': 'felx'}),])
])
...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        yearly_rec=recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        R_chart1 = dcc.Graph(
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
    ...
    # Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            title="Average number of vehicles sold by vehicle type with advertising over Recession Period"))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        #grouping data for plotting
    # Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby('Unemployment_rate')['Vehicle_Type'].mean().reset_index()
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Yearly Mean Automobile sales for the whole period'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, names='Vehicle_Type', values='Advertising_Expenditure', title='Total expenditure for each vehicle {}'.format(selected_year)))
